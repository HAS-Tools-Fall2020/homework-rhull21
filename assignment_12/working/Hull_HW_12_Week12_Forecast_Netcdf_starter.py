# Note this is a workflow analyzing forecast data from UCAR. 
# Here is more information: https://rda.ucar.edu/index.html?hash=data_user&action=register

# ----------------------
# Modified from eek12_Forecast_Netcdf_starter.py in course materials
# QH 11132020
# ----------------------
